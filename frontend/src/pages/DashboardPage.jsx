  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.cardGrid}>
        <DashboardCard title="Applied Jobs" value={appliedJobs.length || 0} />
        <DashboardCard
...
const CompanyDashboard = ({ user, data }) => {
  // Access directly from data to always have the latest count
  const postedJobsCount = data?.postedJobs?.length || 0;
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.cardGrid}>
        <DashboardCard title="Posted Jobs" value={postedJobsCount} />
        <DashboardCard
